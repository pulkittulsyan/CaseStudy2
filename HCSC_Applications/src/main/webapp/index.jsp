...
<script type="text/javascript">
		...
		alert("Here we are 3rd");
		 $.ajax({
			...
			success : function(data) {
				...
				$("[name='Applicant_Full_Name']").val(
						associate.Applicant_Full_Name);
	...
	/* Trial for insertion of json array in db
...
<body>
 ...
 --%>
		...
		<!-- Trail of json object insertion button -->
		<!-- <div style="color: white; padding: 50px 200px 40px 620px">
		<input type="button" value="trail">
		</div> -->
